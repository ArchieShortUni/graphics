...
bool CHeightMapTerrain::Create(char* terrainFilename, char* textureFilename, glm::vec3 origin, float terrainSizeX, float terrainSizeZ, float terrainHeightScale)
{
	...
	m_texture_top.Load("resources\\textures\\TerrainTextures\\10.jpg", true);
	m_texture_high.Load("resources\\textures\\TerrainTextures\\09.jpg", true);
	m_texture_medium.Load("resources\\textures\\TerrainTextures\\07.jpg", true);
	m_texture_low.Load("resources\\textures\\TerrainTextures\\04.jpg", true);
	m_texture_bottom.Load("resources\\textures\\TerrainTextures\\01.jpg", true);
...
{
	m_texture_top.Bind(0);
	m_texture_high.Bind(1);
	m_texture_medium.Bind(2);
	m_texture_low.Bind(3);
	m_texture_bottom.Bind(4);
	m_mesh.Render();
}