...
bool COpenAssetImportMesh::Load(const std::string& Filename, float inst)
{
...
void COpenAssetImportMesh::RenderInstanced()
{
    glBindVertexArray(m_vao);
    ...
    for (unsigned int i = 0; i < m_Entries.size(); i++) {
        ...
        glDrawElementsInstanced(GL_TRIANGLES, m_Entries[i].NumIndices, GL_UNSIGNED_INT, 0, instances);
